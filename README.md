...
Node.jsは、次のいずれかのバージョンとnpmを使用します。

- Node.js 20.19以降の20系
- Node.js 22.13以降の22系
- Node.js 24以降

Next.js 16自体の公式な最低要件はNode.js 20.9です。一方、このリポジトリでテストに使用するVite 8とjsdom 29はより新しいNode.jsを必要とするため、すべての開発ツールが動作する上記の範囲を採用しています。
